...
namespace Gender.Services.DuyVK
{
    public class SystemUserAccountService : ISystemUserAccountService
    {
        ...
        public SystemUserAccountService(IConfiguration configuration)
        {
            _config = configuration;
            _systemUserAccountRepository = new SystemUserAccountRepository();
        }
        ...
        {
            return await _systemUserAccountRepository.GetAsync(username, password);
        }
