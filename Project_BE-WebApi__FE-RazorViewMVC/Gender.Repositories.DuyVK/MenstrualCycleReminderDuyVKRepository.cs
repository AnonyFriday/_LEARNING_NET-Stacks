...
namespace Gender.Repositories.DuyVK
{
    public class MenstrualCycleReminderDuyVKRepository
        : GenericRepository<MenstrualCycleReminderDuyVK>
    {
        // ====================
        // === Constructors
        // ====================

        public MenstrualCycleReminderDuyVKRepository() => _context ??= new GenderContext();
        public MenstrualCycleReminderDuyVKRepository(GenderContext context) => _context = context;
