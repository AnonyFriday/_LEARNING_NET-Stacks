namespace Gender.SoapClients.AppConsole.DuyVK
{
    public static class Helpers
    {
         ...
         * Print reminder list
         */
        public static void PrintReminderList(ICollection<MenstrualCycleReminderDuyVKServiceReference.MenstrualCycleReminderDuyVK> list)
        {
            Console.WriteLine(
            ...
            foreach (var r in list)
            {
                Console.WriteLine(
                    ...
                    DateTime.Parse(r.ReminderDate.ToString()),
                    string.IsNullOrEmpty(r.SentAt.ToString()) ? "-" : DateTime.Parse(r.SentAt.ToString()),
                    r.IsSent,
                    r.RepeatInterval,
                    r.ImportanceScore
                );
         ...
         * Print category list
         */
        public static void PrintCategoryList(ICollection<ReminderCategoryDuyVKServiceReference.ReminderCategoryDuyVK> list)
        {
            Console.WriteLine(
