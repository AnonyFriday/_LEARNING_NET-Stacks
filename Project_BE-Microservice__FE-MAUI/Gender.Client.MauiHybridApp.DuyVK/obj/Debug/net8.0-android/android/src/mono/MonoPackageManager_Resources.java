...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Gender.Client.MauiHybridApp.DuyVK.dll" comes first in this list. */
		"Gender.Client.MauiHybridApp.DuyVK.dll",
		"GoogleGson.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"Gender.BusinessObject.Shared.Models.DuyVK.dll",
		"Gender.Common.Shared.DuyVK.dll",
